...
# Template: lib
# Command: /Users/calebbuahin/Qt5.6.0/5.6/clang_64/bin/qmake -spec macx-clang CONFIG+=debug CONFIG+=x86_64 -o Makefile TriangleComponent.pro
#############################################################################
...
DEFINES       = -DTRIANGLECOMPONENT_LIBRARY -DQT_CORE_LIB
...
INCPATH       = -I. -I. -Iinclude -I../HydroCouple/include -I../HydroCoupleSDK/include -I../../../../Qt5.6.0/5.6/clang_64/lib/QtCore.framework/Headers -Ibuild/debug/.moc -I../../../../Qt5.6.0/5.6/clang_64/mkspecs/macx-clang -F/Users/calebbuahin/Qt5.6.0/5.6/clang_64/lib
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = TriangleComponent1.0.0
DISTDIR = /Users/calebbuahin/Documents/Projects/HydroCouple/TriangleComponent/build/debug/.obj/TriangleComponent1.0.0
...
LIBS          = $(SUBLIBS) -F/Users/calebbuahin/Qt5.6.0/5.6/clang_64/lib -L./../HydroCoupleSDK/build/debug -lHydroCoupleSDK.1.0.0 -framework QtCore 
...
DIST          = ../../../../Qt5.6.0/5.6/clang_64/mkspecs/features/spec_pre.prf \
		...
		include/component/trianglecomponent.h src/stdafx.cpp \
		src/core/triangle.c \
		src/component/trianglecomponent.cpp
...
Makefile: TriangleComponent.pro ../../../../Qt5.6.0/5.6/clang_64/mkspecs/macx-clang/qmake.conf ../../../../Qt5.6.0/5.6/clang_64/mkspecs/features/spec_pre.prf \
		../../../../Qt5.6.0/5.6/clang_64/mkspecs/qdevice.pri \
		../../../../Qt5.6.0/5.6/clang_64/mkspecs/features/device_config.prf \
		../../../../Qt5.6.0/5.6/clang_64/mkspecs/common/unix.conf \
		../../../../Qt5.6.0/5.6/clang_64/mkspecs/common/mac.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/stdafx.h include/trianglecomponent_global.h include/core/triangle.h include/component/trianglecomponent.h $(DISTDIR)/
	$(COPY_FILE) --parents src/stdafx.cpp src/core/triangle.c src/component/trianglecomponent.cpp $(DISTDIR)/
...
build/debug/.obj/triangle.o: src/core/triangle.c 
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/debug/.obj/triangle.o src/core/triangle.c

build/debug/.obj/trianglecomponent.o: src/component/trianglecomponent.cpp 
